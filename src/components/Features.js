...
const features=[
    {
        ...
        description: 'Engage in monthly challenges to enhance your skills',
        img: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1"
    ...
    },
    {
        ...
        description: 'Receive feedback and suggestions from the community',
        img: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1"
                  stroke="currentColor" className="w-16 h-16">
            <path strokeLinecap="round" strokeLinejoin="round"
                ...
                <div className={"mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-3 "}>
                    {
                        features.map((feature, index) => (
                            <div key={index} className={"flex flex-col gap-4"}>
                                ...
                                <Typography.Paragraph className={"text-gray-600 text-sm"}>{feature.description}</Typography.Paragraph>
                        </div>
                    ))
                }
                </div>
